...
// click on deploy.  You'll have to authorize the script to act
// with your account (yes, this should feel scary), there are two
// permissions the script needs, to run whon you're not present.
// (so it can respond to requests from Habitica through the webhooks
// interface, and run time delayed triggers to wait for things
